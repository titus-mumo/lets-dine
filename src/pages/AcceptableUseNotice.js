...
export const Footer = () => {
    ...
    return(
    <div className='w-full py-2 bg-slate-900 mt-auto'>
...
export const Header = () => {
    ...
    return(
    <header className='z-10 flex flex-row justify-between shadow-md p-4 header w-full items-center pb-3'>
        <div className='flex justify-start basis-3/6'>
          <Link to='/' className='poppins text-xl md:text-2xl font-bold hover:cursor-pointer text-blue-500 hover:text-blue-600'>EthnicEats</Link>
        </div>
