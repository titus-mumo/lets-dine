...
export const CuisineCard = ({cuisine}) => {
  ...
  return (
    <div className='flex flex-col m-1 justify-around shadow-md p-1 rounded-md w-400px h-500px hover:cursor-pointer hover:shadow-lg hover:bg-gray-200 transition-transformation duration-300'>
